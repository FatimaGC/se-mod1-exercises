...
describe Venue do
  ...
  describe '#over_capacity?' do
    it 'return false if the venue has less patrons than capacity' do 
      venue = Venue.new('Bluebird', 4)
      venue.add_patron('Mike')
      venue.add_patron('Megan')
      venue.add_patron('Bob')
    ...
    it 'return true if the venue has more patrons than capacity' do
      venue = Venue.new('Bluebird', 4)
      venue.add_patron('Mike')
      venue.add_patron('Megan')
      venue.add_patron('Bob')
...
describe '#kick_out' do 
  it 'will continue to remove patrons from the venue until it is no longer over capacity' do
      venue = Venue.new('Bluebird', 4)
      venue.add_patron('Mike')
      venue.add_patron('Megan')
      venue.add_patron('Bob')
